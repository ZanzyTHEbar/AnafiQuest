...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MatchmakingManager_EndMatch_m16924F8889FDEB613DA50D56412A946604AAAF71 (MatchmakingManager_tF817B6AFD3C4EC74694039EB987CCABCC3AF3BEB* __this, int32_t ___localScore0, int32_t ___remoteScore1, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		V_4 = L_5;
		String_t* L_6;
		L_6 = UInt64_ToString_mD3AAE57EA18A6779F5A17E4F91C900A231EB0A6F((&V_4), NULL);
		V_1 = L_6;
...
IL_0065:
	...
	}
	{
		...
		V_2 = L_45;
		String_t* L_46;
		L_46 = UInt64_ToString_mD3AAE57EA18A6779F5A17E4F91C900A231EB0A6F((&V_2), NULL);
		String_t* L_47;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DataEntry_outputRoomDetails_mFBC32E83BA0B0F4C5EA980A9CF5FD142827D4396 (DataEntry_t52201AA541F537C955253A871AC6A7B123ECBDB9* __this, Room_t0FE13D1487F6CC3D1F413766BECE7EA63BDFBD2C* ___room0, const RuntimeMethod* method) 
{
	...
	int32_t G_B3_0 = 0;
	{
		...
		V_1 = L_9;
		String_t* L_10;
		L_10 = UInt64_ToString_mD3AAE57EA18A6779F5A17E4F91C900A231EB0A6F((&V_1), NULL);
		NullCheck(L_7);
...
IL_006a:
	{
		...
		V_2 = L_22;
		String_t* L_23;
		L_23 = UInt32_ToString_mB6FA6D2459C82ADCF285C55363491D9669A80154((&V_2), NULL);
		String_t* L_24;
	...
	}
	{
		...
		V_1 = L_30;
		String_t* L_31;
		L_31 = UInt64_ToString_mD3AAE57EA18A6779F5A17E4F91C900A231EB0A6F((&V_1), NULL);
		Room_t0FE13D1487F6CC3D1F413766BECE7EA63BDFBD2C* L_32 = ___room0;
		NullCheck(L_32);
...
IL_00d0:
	{
		...
		V_3 = ((int32_t)1086418033);
		int32_t L_46;
		L_46 = UInt32_GetHashCode_mB9A03A037C079ADF0E61516BECA1AB05F92266BC((uint32_t*)(&V_3), NULL);
		// }
		return;
	}
}
...
IL_0078:
	{
		...
		V_2 = L_24;
		// printOutputLine("Error: " + error.Message);
		Error_t0A46640739F2057B84B1EE6489A55DDC224935A4* L_25 = V_2;
		NullCheck(L_25);
...
IL_0036_2:
					{
						...
						NullCheck(L_11);
						VirtualActionInvoker1< int32_t >::Invoke(18 /* System.Void System.IO.BinaryWriter::Write(System.Int32) */, L_11, L_12);
						...
						NullCheck(L_13);
						VirtualActionInvoker1< CharU5BU5D_t799905CF001DD5F13F7DBB310181FC4D8B7D0AAB* >::Invoke(14 /* System.Void System.IO.BinaryWriter::Write(System.Char[]) */, L_13, L_15);
						// writer.Write('\0');
						BinaryWriter_tFB94D67EDFA3F6A34744A163BDABE287FDF2ED1E* L_16 = V_1;
						NullCheck(L_16);
						VirtualActionInvoker1< Il2CppChar >::Invoke(13 /* System.Void System.IO.BinaryWriter::Write(System.Char) */, L_16, 0);
						// }
						goto IL_0066_1;
					}
				}// end try (depth: 2)
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DataEntry_createRoomResponse_m0648FA6FC3692E000420D7486D3FC3BD147B35EC (DataEntry_t045DE3FEA3E4C4CDA8EBD3E546EAC03C3888FA28* __this, Message_1_t3EACAAD86B74B63EFA639D646AFEFB75703066D5* ___msg0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		V_1 = L_7;
		String_t* L_8;
		L_8 = UInt64_ToString_mD3AAE57EA18A6779F5A17E4F91C900A231EB0A6F((&V_1), NULL);
		String_t* L_9;
...
IL_00cb:
	{
		...
		V_4 = L_31;
		// printOutputLine("Error: " + error.Message);
		Error_t0A46640739F2057B84B1EE6489A55DDC224935A4* L_32 = V_4;
		NullCheck(L_32);
...
IL_004e:
	...
	}
	{
		...
		V_2 = L_6;
		String_t* L_7;
		L_7 = UInt64_ToString_mD3AAE57EA18A6779F5A17E4F91C900A231EB0A6F((&V_2), NULL);
		NullCheck(L_4);
