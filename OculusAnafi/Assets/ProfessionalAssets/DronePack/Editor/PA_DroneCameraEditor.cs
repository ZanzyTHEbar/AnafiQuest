...
namespace PA_DronePack
{
    ...
    public class PA_DroneCameraEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            SerializedProperty xSensitivity = serializedObject.FindProperty("xSensitivity");
            EditorGUILayout.PropertyField(xSensitivity);
            SerializedProperty ySensitivity = serializedObject.FindProperty("ySensitivity");
            ...
            SerializedProperty tiltSensitivity = serializedObject.FindProperty("tiltSensitivity");
            EditorGUILayout.PropertyField(tiltSensitivity);
            GUILayout.Space(10f);
